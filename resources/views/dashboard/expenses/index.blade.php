                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title text-right mg-b-0">
                            ...
                            <a href="{{route('dashboard.expenses.create')}}" class="btn btn-success-gradient btn-block">@lang('selfBoxes.add_new_expense')</a>
                        </h4>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                @foreach($expenses as $index =>$expense)
                                    <tr>
                                        ...
                                        <td>{{$expense->date}}</td>
                                        <td>
                                            @if(isset($expense->income->income_type))

                                            {{__('incomes.'.$expense->income->income_type)}}
                                            @else
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-icon-list btn-sm">
                                                ...
                                                @else
                                                    <a href="{{route('dashboard.expenses.edit',$expense->id)}}" class="btn btn-sm btn-indigo btn-icon"><i class="typcn typcn-edit"></i></a>
                                                @endif
                                                    ...
                                                    @else
                                                        <button type="button" class="btn btn-sm btn-primary btn-icon" data-toggle="modal" data-target="#Delete_incentive{{$expense->id}}" ><i class="typcn typcn-trash"></i></button>
                                                    @endif



                                                <button class="btn btn-sm btn-success btn-icon" data-effect="effect-fall" data-toggle="modal" href="#modaldemo{{$expense->id}}"><i class="typcn typcn-eye"></i></button>
                                                <a class="btn btn-sm btn-info btn-icon" href="{{route('dashboard.expenses.show',$expense->id)}}"><i class="typcn typcn-printer"></i></a>
                                            </div>
                                    ...
                                    {{--show modal--}}
                                    <div class="modal effect-slide-in-right effect-scale effect-fall" id="modaldemo{{$expense->id}}" style="display: none;" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                            <div class="modal-content modal-content-demo">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-4">{{number_format($expense->credit)}}</div>
                                                        <div class="col-4">{{$expense->note}}</div>
                                                        <div class="col-4">{{$expense->percentage}}%</div>
                                                    </div>
                                                </div>
                                    ...
                                    @if(!isset($expense->income->income_type))
                                        <div class="modal fade" id="Delete_incentive{{$expense->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
