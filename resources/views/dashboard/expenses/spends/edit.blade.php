        ...
        <div class="col-xl-12">
            <div class="card  box-shadow-0">
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{route('dashboard.spends.update',$spend->id)}}" method="post" data-parsley-validate="">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"  class="form-control" value="{{$spend->debit}}" id="credit" placeholder="{{__('incomes.amount')}}" name="credit" required="">
                        </div>


                        <div class="form-group">
                            <label class="form-label">@lang('incomes.note'): <span class="tx-danger">*</span></label>
                            <textarea class="form-control" id="note" rows="10" name="note" required="">{{$spend->note}}</textarea>
                        </div>
