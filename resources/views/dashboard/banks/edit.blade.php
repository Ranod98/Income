        ...
        <div class="col-xl-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">@lang('banks.edit_expense')</h4>
                    @if ($errors->any())
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{route('dashboard.banks.update',$bank->id)}}" method="post" data-parsley-validate="">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"  class="form-control" value="{{$bank->credit}}" id="credit" placeholder="{{__('incomes.amount')}}" name="credit" required="">
                        </div>


                        <div class="form-group">
                            <label class="form-label">@lang('incomes.note'): <span class="tx-danger">*</span></label>
                            <textarea class="form-control" id="note" rows="10" name="note" required="">{{$bank->note}}</textarea>
                        </div>
