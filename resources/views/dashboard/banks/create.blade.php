        ...
        <div class="col-xl-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">@lang('banks.add_bank')</h4>
                    @if ($errors->any())
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{route('dashboard.banks.store')}}" method="post" data-parsley-validate="">
                        @csrf
