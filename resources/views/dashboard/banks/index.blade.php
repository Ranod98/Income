                ...
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title text-right mg-b-0">
                            ...
                            <a href="{{route('dashboard.banks.create')}}" class="btn btn-success-gradient btn-block">@lang('banks.add_new_bank')</a>
                        </h4>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <table class="table text-md-nowrap" id="example2">
                                ...
                                @foreach($banks as $index =>$bank)
                                    <tr>
                                        <td>{{$index + 10001}}</td>
                                        <td>{{$bank->date}}</td>
                                        <td>{{number_format($bank->credit)}}</td>
                                        <td>{{$bank->note}}</td>
                                        <td>

                                            <div class="btn-icon-list btn-sm">

                                                <a href="{{route('dashboard.banks.edit',$bank->id)}}" class="btn btn-sm btn-indigo btn-icon"><i class="typcn typcn-edit"></i></a>
                                                ...
                                                <a class="btn btn-sm btn-info btn-icon" href="{{route('dashboard.banks.show',$bank->id)}}"><i class="typcn typcn-printer"></i></a>
                                            </div>
