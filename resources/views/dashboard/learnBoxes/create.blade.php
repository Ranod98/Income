...
@section('title')
    @lang('selfBoxes.add_new_learnBox')
@endsection
@section('page-header')
    <!-- breadcrumb -->
        ...
        <div class="col-xl-12">
            <div class="card  box-shadow-0">
                <div class="card-header">
                    <h4 class="card-title mb-1">@lang('selfBoxes.add_learnBox')</h4>
                    @if ($errors->any())
                ...
                <div class="card-body pt-0">
                    <form class="form-horizontal" action="{{route('dashboard.learnboxes.store')}}" method="post" data-parsley-validate="">
                        @csrf
